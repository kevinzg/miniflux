...
`,
	"schema_version_35": `alter table entries add column original_id text default '';
`,
...
var SqlMapChecksums = map[string]string{
	...
	"schema_version_35": "253e981306e3bd540e994d2684a1d5a1df2db46d546d2a577771e93acceeeea8",
